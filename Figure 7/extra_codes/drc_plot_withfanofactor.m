function drc_plot_withfanofactor(psth, fanofactor, chan, window, k)
% INPUT:
...
fig_indx = 1:2:14*2;
colorIdx = [2,6];
subaxis(14,2,fig_indx(2*(k-1) +1) , 'sv', 0.01);
...
subaxis(14,2,fig_indx(2*(k-1) +2) , 'sv', 0.01);
